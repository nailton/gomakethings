...
<html <?php language_attributes(); ?>>
	...
	<head>
		...
		<script src="<?php bloginfo('stylesheet_directory'); ?>/dist/js/detects.min.08052014.3.js"></script>
		...
		<!-- Stylesheet -->
		<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/dist/css/gmt.min.08052014.css">
